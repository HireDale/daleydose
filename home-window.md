...
| **NOTES** | Displays existing notes for the highlighted medication in the prescription.<br><br>**NOTE:** You can attach up to 5 notes per medication. |
...
| **+ MEDS** | Select to add medication to the current prescription.<br><br>When you select this button, the application opens the **Add Medication** window.<br><br>**NOTE:** The application auto-completes generic and brand name suggestions for each medication. You can turn off this feature in the **Options** window. |
| **+ NOTES** | Select to add notes to the selected medication.<br><br>When you select this button, the application opens the **Add Notes** window. |
...
| **SCAN** | Select to scan a handwritten prescription and create a digital version in a new prescription window.<br><br>When you select this button, the application opens the **Scan** window.<br><br>**NOTES:**<br>– The application displays this button on the desktop version only when your computer has a confirmed connected webcam.<br>– The application always displays this button on the mobile app. |
