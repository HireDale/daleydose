...
| **+ MEDS** | Select **+ Meds** to add medication to the current prescription.<br><br>When you select this button, the application opens the **Add Medication** window.<br><br>**NOTE:** The application auto‑completes generic and brand name suggestions for each medication. You can turn off this feature in the **Options** window. |
| **+ NOTES** | Select **+ Notes** to add notes to the selected medication.<br><br>When you select this button, the application opens the **Add Notes** window. |
