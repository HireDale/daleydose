...
| **+ Alt** | Select to add an alternative option for the pharmacy in case the prescribed medication is not available.<br><br>When you select this button, the application displays the Add alternative window.<br><br>NOTE: The application auto-completes generic and brand name suggestions for each medication. You can turn off this feature in the Options window. |
